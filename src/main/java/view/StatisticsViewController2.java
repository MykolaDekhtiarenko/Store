...
public class StatisticsViewController2 implements Controller{
    ...
    private JButton employeesTabButton;
    private JButton departmentsTabButton;
    private JButton addProductButton;

    private Screen screen;


    public StatisticsViewController2(Screen screen) {
        this.screen = screen;
        initialize();
        employeesTabButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                goToEmployeeView();
            }
        });
        departmentsTabButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                goToDepartmentView();
            }
        ...
        addProductButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AddProductController addProductController = new AddProductController(screen);
            }
        });
    }
